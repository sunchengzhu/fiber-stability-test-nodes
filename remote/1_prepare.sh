...
if [ "$1" == "develop" ]; then
  download_url="http://github-test-logs.ckbapp.dev/fiber/fnn_develop_20250912_1030-x86_64-linux-portable.tar.gz"
elif [ "$1" == "mpp" ]; then
  ...
  download_url="http://github-test-logs.ckbapp.dev/fiber/fnn_debug_20250916_2000-x86_64-linux-portable.tar.gz"
